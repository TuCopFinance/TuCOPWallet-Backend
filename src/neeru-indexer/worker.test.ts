...
describe('handleKindD', () => {
  ...
  // first locked category. The reconstructed startTs is endTs - 30 days.
  const secsCat1 = 30n * 86_400n
  const reconstructedStartTs = endTs - secsCat1
  ...
  function makeCtx(): NeeruOnchainBatchContext {
    return {
      ...
      secsByCategory: new Map([[1, secsCat1]]),
    }
  }
