...
const envSchema = z.object({
  ...
  // Topic0 surfaced by GET /api/meta/contracts/neeru so the wallet
  // stops hardcoding it locally. Distinct from the four indexer
  // NEERU_EVENT_*_TOPIC0 vars. Optional: endpoint returns events: {}
  // when unset.
